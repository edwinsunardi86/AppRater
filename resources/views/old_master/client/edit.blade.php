                        ...
                        <form method="post" id="form_client" class="form-horizontal">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="hidden" id="client_id" name="client_id" value="{{ $data_client->id }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="address" class="form-control" id="address" cols="50" rows="5">{{ $data_client->address }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-4">
                                        ...
                                        <input type="text" name="phone1" id="phone1" class="form-control" value="{{ $data_client->contact1 }}" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="input-group col-sm-4">
                                        ...
                                        <input type="text" name="phone2" id="phone2" class="form-control" value="{{ $data_client->contact2 }}" data-inputmask='"mask": "(999) 999-9999"' data-mask>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group row">
                                    <label for="inputContact1" class="col-sm-2 col-form-label">Mobile</label>
                                        ...
                                        <div class="input-group col-sm-2">
                                            <input type="text" name="mobile" id="mobile" class="form-control" value="{{ $data_client->mobile }}">
                                        </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea name="description" class="form-control" id="description" cols="50" rows="5">{{ $data_client->description }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
